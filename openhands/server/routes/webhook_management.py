...
from openhands.storage.webhook import FileWebhookStore, create_webhook_config, create_webhook_log
...
async def create_webhook(
    ...
    try:
        # Get webhook store
        webhook_store = await FileWebhookStore.get_instance(config, current_user.user_id)
        ...
        webhook = create_webhook_config(
            ...
            secret=webhook_data.secret.get_secret_value() if webhook_data.secret else None,
        )
