...
class WebhookLog(BaseModel):
    ...
    user_id: str = Field(..., description="User ID that owns this webhook")
    event_type: WebhookEventType = Field(..., description="Type of event that triggered the webhook")
    repository: Optional[str] = Field(
...
class WebhookConfigCreate(BaseModel):
    ...
    url: HttpUrl
    events: list[WebhookEventType] = Field(default_factory=lambda: [WebhookEventType.ALL])
